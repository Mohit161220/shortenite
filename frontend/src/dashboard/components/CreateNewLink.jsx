    ...
    return(
        <div className="flex place-content-center place-items-center w-full h-5/6 ">
            <div className="flex flex-col justify-evenly w-3/5 h-5/6 rounded-lg shadow-lg">
                ...
                <div className="mx-8">
                    <label className="text-lg font-semibold" for="title">Custom back-half (optional)</label>
                    <Input className="mt-3" variant="outline" placeholder="" />
                </div>

                <div className="mx-8"> 
                    <label className="text-lg font-semibold mr-5" for="title">QR Code (optional)</label>
