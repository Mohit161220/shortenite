...
const Qr = () => {
  ...
  return (
    ...
    <div className=''>
      ...
      <div className="sticky top-16 grid grid-col-12 w-full h-16 md:h-24 shadow-md">

        <span className="col-span-1 text-xl sm:text-2xl md:text-3xl lg:text-4xl my-4 md:my-6 pl-3 md:pl-8 font-semibold ">QR</span>
